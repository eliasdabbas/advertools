...
htmlhelp_basename = 'advertoolsdoc'
...
latex_documents = [
    (master_doc, 'advertools.tex', 'advertools Documentation',
     'Elias Dabbas', 'manual'),
]
...
man_pages = [
    (master_doc, 'advertools', 'advertools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'advertools', 'advertools Documentation',
     author, 'advertools', 'One line description of project.',
     'Miscellaneous'),
]
