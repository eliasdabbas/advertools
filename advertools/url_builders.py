...
def url_utm_ga(url, utm_source, utm_medium=None, utm_campaign=None,
    ...
    :param utm_source: the referrer of the traffic (e.g. facebook, twitter), required
    :param utm_medium: marketing medium (e.g. banner, email)
    :param utm_campaign: the name of the campaign (e.g. summer_promo, 20pct_off)
    :param utm_content: ad name / differentiator (e.g. 728x90, mpu, square_banner)
